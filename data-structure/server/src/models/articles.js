...
const getOne = (title) => articles_db.find((article) => article.title === title);

const getById = (id) => articles_db.find((article) => article._id === parseInt(id));
...
export {
  comments_db, getAll, getOne, getById, getCommentsByArticleId, getAllByTag,
};
